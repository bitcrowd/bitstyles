      ...
      <div class="u-flex u-height-100vh">
        <nav class="u-flex">
          ...
          <div class="o-sidebar--small u-bg-gray-dark u-flex u-flex-col u-hidden@l">
            <button class="u-flex-shrink-0 a-button a-button--icon a-button--icon-reversed u-margin-2xs-left" title="Close menu" aria-controls="navbar-1" aria-expanded="true">

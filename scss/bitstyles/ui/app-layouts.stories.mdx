  ...
  <Story name="Sidebar, header, fullwidth content" inline={false} height="80vh">
    {`
      <div class="u-flex u-height-100vh">
        <nav class="u-flex">
          <div class="u-hidden o-sidebar--large u-flex-shrink-0 u-bg-gray-dark u-padding-m-top u-flex@l u-flex-col">
        ...
        <main class="u-flex-grow-1 u-flex u-flex-col">
          <header class="u-bg-gray-lighter u-padding-l-top u-flex-shrink-0">
              ...
              <div class="u-padding-xl-bottom">
                <ol class="u-h6 a-list-reset u-flex u-flex-wrap u-items-center">
                  <li class="u-margin-xs-right u-flex u-items-center">
                    ...
                    <svg width="18" height="18" class="a-icon a-icon--m u-fg-gray-light u-margin-xs-left" aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
            ...
            <form action="" method="POST" role="search" class="u-margin-m-bottom u-flex">
              ...
              <ul class="o-ui-group u-flex a-list-reset">
                ...
                <li class="u-flex u-relative">
                  <button type="button" class="a-button a-button--ui u-border-radius-0-tl u-border-radius-0-bl">
                    Filter
                  </button>
                </li>
              </ul>

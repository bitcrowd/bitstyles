...
<Canvas>
   <Story name="Sidebar">
     {`
        <nav class="u-flex u-height-100vh">
          <div class="u-hidden a-sidebar u-flex__shrink-0 u-bg--gray-80 u-padding-m--top u-flex@l u-flex--col">
            ...
            <div class="u-hidden@l">
              <img src="${logoSmall}" width="150" height="50" alt="Company logo" class="u-flex__shrink-0 u-margin-m--left u-margin-m--right u-margin-m--bottom" />
            </div>
          </nav>
          <main class="u-flex__grow u-padding-xl--left u-padding-xl--right u-overflow--y">
            <h1>Main content</h1>

...
<details class="u-margin-xl--y">
  ...
  <ul>
    <li><a href="/?path=/story/atoms-avatar--avatar">a-avatar</a></li>
    ...
    <li><a href="/?path=/story/atoms-button-icon-reversed--icon-reversed">a-button--icon-reversed</a></li>
    <li><a href="/?path=/story/atoms-button-nav--nav">a-button--nav</a></li>
    <li><a href="/?path=/story/atoms-button-nav-large--nav-large">a-button--nav-large</a></li>
    ...
    <li><a href="/?path=/story/utilities-hidden--hidden">u-hidden</a></li>

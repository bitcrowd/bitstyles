   ...
   <Story name="Sidebar">
     {`
        <div class="u-flex u-height-100vh">
          <nav class="a-sidebar u-flex__shrink-0 u-bg--gray-80 u-padding-m--top u-flex u-flex--col">
            ...
            <ul class="u-flex__grow-1 a-list-reset u-flex u-flex--col u-items-stretch u-padding-xs--right u-padding-xs--left">
          ...
          <main class="u-flex__grow u-padding-xl">
            <h1>Main content</h1>
          </main>
        </div>
     `}

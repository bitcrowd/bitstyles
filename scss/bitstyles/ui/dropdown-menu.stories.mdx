...
A button that when clicked reveals a floating menu of links. This is a combination of an `.a-button--secondary` as the button that is clicked to show/hide the menu, an `.a-dropdown` menu that’s the container for a series of `.a-button--menu a-button--transparent` sub-items.
...
<details class="u-margin-xl-y">
  ...
  <ul>
    ...
    <li>
      <a href="/docs/atoms-button-menu--menu">a-button--menu a-button--transparent</a>
    </li>
    <li>
...
- the standard menu items are likely to be created using `.a-button.a-button--menu a-button--transparent`
    ...
    {`
      <div style="min-height:20rem;">
        <div class="u-relative" x-data="{ dropdownOpen: false }">
          ...
          >
            <li>
              <a href="/" class="a-button a-button--menu a-button--transparent u-h6">
                <svg width="14" height="14" class="a-icon a-icon-m" aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
      ...
      <div style="height: 20rem" class="u-flex u-flex-col">
        ...
        <div class="u-relative u-flex u-justify-end" x-data="{ dropdownOpen: false }">
          <button
            ...
            :aria-expanded="dropdownOpen"
          >
            <span>Account [full-width, top]</span>
            <svg width="14" height="14" class="a-icon a-icon-m" aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
              <use xlink:href="${icons}#icon-caret-down"></use>
            </svg>
          </button>

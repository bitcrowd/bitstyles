...
Sass still supports the `@import` directive. Though it’ll be deprecated and gone soon, bitstyles can for now still be configured and built using this method. It’s really recommended that you use the `@use` approach shown above.

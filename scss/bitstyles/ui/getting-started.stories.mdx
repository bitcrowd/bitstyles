...
Although deprectaed, Sass still supports the `@import` directive. Bitstyles can for now still be configured and built using this method, but it’s recommended that you use the `@use` approach shown above.

...
```scss
@use '~bitstyles/scss/bitstyles/design-tokens/color-palette' with ($text: #fff, /* lots of options */);
@use '~bitstyles/scss/bitstyles/design-tokens/layout' with ($size-base: 1.2rem, /* lots of options */);
@use '~bitstyles/scss/bitstyles';
```

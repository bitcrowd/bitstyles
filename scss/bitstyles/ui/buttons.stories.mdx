...
Buttons are available in a variety of sizes: `small`, `default`, `large`, `icon`. See [Button sizes](/docs/atoms-button-forms--small-primary) for details on customizing these.

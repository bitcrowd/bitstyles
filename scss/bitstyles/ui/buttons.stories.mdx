...
Buttons are available in a variety of forms: `small`, `default`, `large`, `square`, `round`. See [Button sizes](/docs/atoms-button-forms--small-primary) for details on customizing these.

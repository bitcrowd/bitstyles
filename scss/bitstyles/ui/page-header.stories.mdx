...
- [breadcrumbs](/?path=/story/ui-navigation-breadcrumbs--breadcrumbs)
- page title
- status [badge](/?path=/story/atoms-badge--badge)
- action [buttons](/?path=/story/ui-buttons-buttons--page)
- [tabs](/?path=/story/ui-navigation-tabs--tabs) for organising the content (note that no tabpanels are shown here)
...
<details class="u-margin-xl--y">
  ...
  <ul>
    ...
    <li><a href="/?path=/story/atoms-button-tab--tab">a-button--tab</a></li>
    ...
    <li><a href="/?path=/story/utilities-background-color--gray-80">u-bg</a></li>
    <li><a href="/?path=/story/utilities-break-text--break-text">u-break-text</a></li>
    ...
    <li><a href="/?path=/story/utilities-box-alignment--justify-between">u-justify-between</a></li>
    <li><a href="/?path=/story/utilities-margin--margin-m">u-margin</a></li>
    <li><a href="/?path=/story/utilities-overflow--overflow-x">u-overflow</a></li>
    <li><a href="/?path=/story/utilities-padding--padding-m">u-padding</a></li>
    <li><a href="/?path=/story/utilities-relative--relative">u-relative</a></li>
  </ul>
</details>

...
<Canvas isColumn>
  <Story name="Page header">
    {`
      <article>
        <header class="u-bg-grayscale-light-1 u-padding-l2-top u-shadow-brand-1">
          <div class="a-content">
            <div class="u-padding-l3-bottom">
              <ol class="u-h7 u-list-none u-flex u-flex-wrap u-items-center">
              ...
              <div class="u-flex u-justify-between u-flex-wrap u-items-center u-margin-m-top">
                ...
                <ul class="u-list-none u-flex u-flex-wrap">
                  <li class="u-margin-s2-right u-margin-m-bottom u-relative@m" x-data="{ dropdownOpen: false }">
                    <button
                      type="button"

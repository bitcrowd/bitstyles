...
1. _Base styles_ Styles applied to elements, no classnames.
1. _Components_ Styles applied to encapsulated blocks of UI, like buttons, dropdown menus, card interfaces, modals. Always classnames.
1. _Utilities_ Apply a single CSS property, useful as an override for default/component styles, or to avoid creating a whole new component module for a common or simple task.

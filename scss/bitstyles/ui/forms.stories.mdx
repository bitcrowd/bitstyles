...
<details class="u-margin-xl-y">
  ...
  <ul>
    ...
    <li><a href="/docs/utilities-box-alignment--justify-end">u-justify</a></li>
      ...
      <form action="" method="POST" class="a-content">
        ...
        <fieldset class="u-margin-xl-bottom u-padding-xl-bottom">
          ...
          <div class="u-grid u-gap-m u-grid-cols-6@l u-gap-m">
            <ul class="a-list-reset u-grid__col-3@l u-grid u-gap-m u-grid-cols-6@m u-col-span-4@l">
              <li class="u-col-span-4@m u-grid__col-1@m u-col-span-3@l">
              ...
              <li class="u-grid__col-1@m u-col-span-2@m">
        ...
        <fieldset class="u-margin-xl-bottom u-padding-xl-bottom">
          ...
          <div class="u-grid u-gap-m u-grid-cols-6@l">
            ...
            <ul class="a-list-reset u-grid__col-3@l u-col-span-4@l u-grid u-gap-m u-grid-cols-6@m u-gap-m">
              ...
              <li class="u-grid__col-1@m u-grid__col-1@l u-col-span-3@m">
        ...
        <div class="u-grid u-gap-m u-grid-cols-6@l u-gap-m u-margin-xl-bottom">
          <ul class="a-list-reset u-flex u-items-center u-grid__col-3@l u-col-span-4@l">
        ...
        <fieldset>
          ...
          <div class="u-grid u-gap-m u-grid-cols-6@l u-margin-xl-bottom">
            <ul class="a-list-reset u-grid u-gap-m u-grid-cols-6@m u-col-span-4@l">
              <li class="u-col-span-4@m u-grid__col-1@m">
                <label for="name">Name</label>
                <input id="name" type="text" autocomplete="name" value="Jon Doe" />
              </li>
              <li class="u-col-span-4@m u-grid__col-1@m">

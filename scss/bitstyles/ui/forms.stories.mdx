...
<Meta title="UI/Data/Forms/Overview" />
        ...
        <fieldset class="u-margin-l3-bottom u-padding-l3-bottom">
          ...
          <div class="u-grid u-gap-m u-grid-cols-6@l">
            <ul class="u-list-none u-col-start-3@l u-grid u-gap-m u-grid-cols-6@m u-col-span-4@l">
              <li class="u-col-span-4@m u-col-start-1@m u-col-span-3@l u-flex u-flex-col">
              ...
              <li class="u-col-start-1@m u-col-span-2@m u-flex u-flex-col">
        ...
        <fieldset class="u-margin-l3-bottom u-padding-l3-bottom">
          ...
          <div class="u-grid u-gap-m u-grid-cols-6@l">
            ...
            <ul class="u-list-none u-col-start-3@l u-col-span-4@l u-grid u-gap-m u-grid-cols-6@m">
              <li class="u-col-span-4@m u-col-span-3@l u-flex u-flex-col">
                <label for="street">Street</label>
                <input id="street" type="text" autocomplete="address-line1" />
              </li>
              <li class="u-col-span-2@m u-col-span-1@l u-flex u-flex-col">
                <label for="house">House Nr.</label>
                <input id="house" type="text" />
              </li>
              <li class="u-col-start-1@m u-col-start-1@l u-col-span-3@m u-flex u-flex-col">
                <label for="city">City</label>
                <input id="city" type="text" autocomplete="address-line2" />
              </li>
              <li class="u-col-span-3@m u-flex u-flex-col">
                <label for="country">Country</label>
                <input id="country" type="text" autocomplete="country-name" />
              </li>
              <li class="u-col-span-2@m u-flex u-flex-col">
...
<Canvas>
  <Story id="ui-data-forms--search-form-with-button" />
</Canvas>

<Canvas>
  <Story id="ui-data-forms--search-form-with-icon-button" />
</Canvas>
...
<Canvas>
  <Story id="ui-data-forms--search-form-with-select-and-button" />
</Canvas>

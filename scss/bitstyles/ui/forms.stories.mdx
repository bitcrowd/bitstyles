...
<Canvas>
  <Story name="Search form">
    ...
    <form role="search" action="" method="POST" class="u-flex o-ui-group">
      ...
      <button type="submit" class="a-button a-button--secondary o-ui-group__item o-ui-group__last u-round-0-tl u-round-0-bl">Search</button>
    </form>
    `}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Search form with icon button">
    ...
    <form role="search" action="" method="POST" class="u-flex o-ui-group">
      ...
      <button type="submit" class="a-button a-button--secondary o-ui-group__item o-ui-group__last u-round-0-tl u-round-0-bl" title="Search users">

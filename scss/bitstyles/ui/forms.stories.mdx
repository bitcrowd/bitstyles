...
For a more complex form, `.u-grid--6-col@m` allows for fields of different sizes on larger screens. Combine it width fieldsets, legends, and the [bordered-header](/docs/atoms-bordered-header--bordered-header) atom.

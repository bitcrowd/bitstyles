...
<Canvas>
  <Story name="Search form">
    ...
    <form role="search" action="" method="POST" class="u-flex o-ui-group">
      ...
      <button type="submit" class="a-button a-button--ui o-ui-group__item o-ui-group__last u-border-radius-0-tl u-border-radius-0-bl">Search</button>
    </form>
    `}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Search form with icon button">
    ...
    <form role="search" action="" method="POST" class="u-flex o-ui-group">
      ...
      <button type="submit" class="a-button a-button--ui o-ui-group__item o-ui-group__last u-border-radius-0-tl u-border-radius-0-bl" title="Search users">
  ...
  <Story name="Select input and button">
    ...
    <form role="search" action="" method="POST" class="u-flex">
      <ul class="a-list-reset u-flex u-items-end">
        ...
        <li>
          <button type="submit" class="a-button a-button--ui">Search</button>
        </li>
      </ul>
    </form>
    `}

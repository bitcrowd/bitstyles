...
<details class="u-margin-xl--y">
  ...
  <ul>
    ...
    <li><a href="/?path=/story/atoms-button-mode-mode">a-button--mode</a></li>
...
<Canvas>
  <Story name="Mode-switch buttons">
    {`
      <ul class="a-list-reset u-flex u-flex--inline u-items-stretch u-items-center a-button--mode-container u-padding-xs u-bg--gray-20">

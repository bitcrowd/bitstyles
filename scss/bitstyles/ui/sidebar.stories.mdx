      ...
      <div class="u-flex u-height-100vh" x-data="{ sidebarOpen: false }">
        <nav class="u-flex">
          <div class="u-hidden o-sidebar--large u-flex-shrink-0 u-bg-grayscale-dark-2 u-padding-m-top u-flex@l u-flex-col">
            ...
            <div
              class="u-flex-shrink-0 u-padding-xs-y u-margin-xs-left u-margin-xs-right u-border-grayscale-dark-top u-relative u-flex u-flex-col"
              x-data="{ dropdownOpen: false }"
            >
              <button
                type="button"
                class="a-button a-button--large a-button--secondary"
          ...
          <div
            class="o-sidebar--small u-bg-grayscale-dark-1u-flex u-flex-col u-hidden@l"
            x-show="sidebarOpen"
          ...
          >
            <button
              class="u-flex-shrink-0 a-button a-button--square a-button--secondary u-margin-2xs-left"
              title="Close menu"
            ...
            <div
              class="u-flex-shrink-0 u-padding-xs-y u-margin-xs-left u-margin-xs-right u-border-grayscale-dark-top u-relative"
              x-data="{ dropdownOpen: false }"
            >
              <button
                type="button"
        ...
        <main class="u-flex-grow-1 u-padding-2xl-left@l u-padding-xl-right@l u-padding-xl-bottom u-padding-m u-overflow-y-auto">
          <div class="u-flex u-items-center u-margin-m-bottom">
            <button
              class="u-flex-shrink-0 u-margin-neg-m-left a-button a-button--square a-button--secondary u-margin-xs-right u-hidden@l"
              title="Open menu"
              aria-controls="navbar-1"
              aria-expanded="sidebarOpen"
...
```scss
$small-location: left;
$small-box-shadow: size.get('m') 0 size.get('l') rgba(palette.get('brand-1'), 0.1),
  size.get('l') 0 size.get('m') rgba(palette.get('grayscale', 'light-1'), 0.07),
  0 0 size.get('xl') rgba(palette.get('grayscale', 'light-1'), 0.1);
```

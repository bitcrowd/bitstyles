    ...
    {`
      <div class="u-flex u-height-100vh" x-data="{ sidebarOpen: false }">
        <nav class="u-flex">
          ...
          >
            <button
              class="u-flex-shrink-0 a-button a-button--square a-button--secondary u-margin-s6-left"
              title="Close menu"
...
```scss
$small-location: left;
$small-box-shadow: var(design-token.get('size', 'm') 0 var(design-token.get('size', 'l2') rgba(var(design-token.get('color', 'brand-1'), 0.1),
  var(design-token.get('size', 'l2') 0 var(design-token.get('size', 'm') rgba(var(design-token.get('color', 'grayscale', 'light-1'), 0.07),
  0 0 var(design-token.get('size', 'l3') rgba(var(design-token.get('color', 'grayscale', 'light-1'), 0.1);
```

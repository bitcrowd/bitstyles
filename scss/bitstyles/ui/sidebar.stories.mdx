  ...
  <Story name="Sidebar" inline={false} height="80vh">
    {`
      <div class="u-flex u-height-100vh" x-data="{ sidebarOpen: false }">
        <nav class="u-flex">
          <div class="u-hidden o-sidebar--large u-flex-shrink-0 u-bg-grayscale-light-4 u-padding-m-top u-flex@l u-flex-col">
            ...
            <ul class="u-flex-grow-1 u-flex-shrink-1 u-overflow-y-auto u-list-none u-flex u-flex-col u-items-start u-items-stretch u-padding-s4-right u-padding-s4-left">
              <li class="u-margin-s2-bottom u-flex">
                <a href="/" class="a-button a-button--transparent u-flex-grow-1 u-justify-start">
              ...
              <li class="u-margin-s2-bottom u-flex">
                <a href="/" class="a-button a-button--transparent u-flex-grow-1 u-justify-start" aria-current="page">
                  <svg width="16" height="16" class="a-button-nav__icon a-icon a-icon--m u-margin-s2-right u-margin-neg-s6-left" aria-hidden="true" focusable="false">http://localhost:6006/?path=/story/introduction-principles--page
            ...
            <div
              class="u-flex-shrink-0 u-padding-s4-y u-margin-s4-left u-margin-s4-right u-border-grayscale-dark-top u-relative u-flex u-flex-col"
          ...
          <div
            class="o-sidebar--small u-bg-grayscale-light-4 u-shadow-brand-1 u-flex u-flex-col u-hidden@l"
            x-show="sidebarOpen"
          ...
          >
            <button
              class="u-flex-shrink-0 a-button a-button--square a-button--transparent u-margin-s6-left"
              title="Close menu"
            ...
            <ul class="u-flex-grow-1 u-flex-shrink-1 u-overflow-y-auto u-list-none u-flex u-flex-col u-items-stretch u-items-start u-padding-s4-right u-padding-s4-left">
              <li class="u-margin-s2-bottom u-flex u-items-start">
                <a href="/" class="a-button a-button--transparent u-flex-grow-1 u-justify-start">
                  <svg width="16" height="16" class="a-button-nav__icon a-icon a-icon--m u-margin-s2-right u-margin-neg-s6-left" aria-hidden="true" focusable="false">
                    <use xlink:href="${icons}#icon-home"></use>
                  </svg>
        ...
        <main class="u-flex-grow-1 u-padding-l4-left@l u-padding-l3-right@l u-padding-l3-bottom u-padding-m u-overflow-y-auto">
          <div class="u-flex u-items-center u-margin-m-bottom">
            <button
              class="u-flex-shrink-0 u-margin-neg-m-left a-button a-button--square a-button--secondary u-margin-s4-right u-hidden@l"
              title="Open menu"
              aria-controls="navbar-1"
              aria-expanded="sidebarOpen"

...
```scss
$small-location: left;
$small-box-shadow: size.get('m') 0 size.get('l2') rgba(palette.get('brand-1'), 0.1),
  size.get('l2') 0 size.get('m') rgba(palette.get('grayscale', 'light-1'), 0.07),
  0 0 size.get('l3') rgba(palette.get('grayscale', 'light-1'), 0.1);
```

    ...
    {`
      <nav aria-label="pagination">
        <ul class="u-list-none u-inline-flex u-items-stretch o-ui-group">
          ...
          <li class="u-flex">
            <a href="/" class="a-button a-button--ui o-ui-group__item u-border-radius-0">
              1
            </a>
          </li>
          <li class="u-flex">
            <a href="/" class="a-button a-button--ui o-ui-group__item u-border-radius-0" aria-current="page">
              2
            </a>
          </li>
          <li class="u-flex">

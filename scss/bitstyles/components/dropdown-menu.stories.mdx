...
The structure can be a little simpler if your menu items do not need icons. Here we’ve also added a link to the user’s profile, with their avatar, as a link at the top of the menu.
  ...
  <Story name="Dropdown with avatar user-profile link">
    {`
      <div class="l-relative" style="min-height:20rem;">
        ...
        <ul class="o-dropdown o-overflow o-list-reset u-margin-s--top">
          <li>
            <a href="/" class="o-button o-button--menu o-h6">
  ...
  <Story name="Dropdown with non-button/link content">
    {`
      <div class="l-relative" style="height: 20rem; width: 30rem">
        ...
        <ul class="o-dropdown o-overflow o-list-reset u-margin-s--top" aria-hidden="false" id="dropdown-1">
          <li>
            <div class="u-padding-xs--top u-padding-xs--bottom u-padding-s--left u-padding-s--right l-flex l-items-center o-h6 u-line-height--min">

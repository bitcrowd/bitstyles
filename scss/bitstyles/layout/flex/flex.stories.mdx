...
**Some of these examples will cause horizontal scrollbars** at some viewport widths. That’s deliberate and important — your approach to dealing with that issue will depend on your content, but probably `.l-flex--wrap` will be among the first places to look (see below).
...
<Canvas isColumn>
  ...
  <Story name="Flex, with primary child">
    {`
      <ul class="l-flex o-list-reset">
        <li>List item one</li>
        <li class="l-flex__primary u-bg--secondary">Important content here</li>
        <li>List item three</li>
        <li>List item four</li>
      </ul>
    `}
...
<Canvas isColumn>
  ...
  <Story name="Flex with long content, with no-shrink child">
    {`
      <ul class="l-flex o-list-reset">
        <li>Gingerbread topping tart. Bear claw cake icing cotton candy cheesecake biscuit pudding. Macaroon gummi bears chocolate bar lollipop. Caramels marzipan halvah fruitcake chocolate cake cake tart pudding. Bonbon sweet roll fruitcake soufflé topping fruitcake sesame snaps muffin. Pudding dragée marzipan ice cream topping chocolate cake fruitcake bear claw muffin.</li>
        <li class="l-flex__no-shrink u-bg--secondary">Important content here. Gingerbread topping tart. Bear claw cake icing cotton candy cheesecake biscuit pudding. Macaroon gummi bears chocolate bar lollipop. Caramels marzipan halvah fruitcake chocolate cake cake tart pudding. Bonbon sweet roll fruitcake soufflé topping fruitcake sesame snaps muffin. Pudding dragée marzipan ice cream topping chocolate cake fruitcake bear claw muffin.</li>
        <li>Gingerbread topping tart. Bear claw cake icing cotton candy cheesecake biscuit pudding. Macaroon gummi bears chocolate bar lollipop. Caramels marzipan halvah fruitcake chocolate cake cake tart pudding. Bonbon sweet roll fruitcake soufflé topping fruitcake sesame snaps muffin. Pudding dragée marzipan ice cream topping chocolate cake fruitcake bear claw muffin.</li>
        <li>Gingerbread topping tart. Bear claw cake icing cotton candy cheesecake biscuit pudding. Macaroon gummi bears chocolate bar lollipop. Caramels marzipan halvah fruitcake chocolate cake cake tart pudding. Bonbon sweet roll fruitcake soufflé topping fruitcake sesame snaps muffin. Pudding dragée marzipan ice cream topping chocolate cake fruitcake bear claw muffin.</li>
      </ul>
    `}
...
<Canvas isColumn>
  ...
  <Story name="Flex with intrinsic-width content, with primary child">
    {`
      <ul class="l-flex o-list-reset">
        <li><img src="https://placekitten.com/300/300" width="300" height="300" class="l-block" /></li>
        <li class="l-flex__primary u-bg--secondary"><img src="https://placekitten.com/300/300" width="300" height="300" class="l-block" /></li>
        <li><img src="https://placekitten.com/300/300" width="300" height="300" class="l-block" /></li>
        <li><img src="https://placekitten.com/300/300" width="300" height="300" class="l-block" /></li>
      </ul>
    `}
  ...
  <Story name="Flex with intrinsic-width content, with no-shrink child">
    {`
      <ul class="l-flex o-list-reset">
        <li><img src="https://placekitten.com/300/300" width="300" height="300" class="l-block" /></li>
        <li class="l-flex__no-shrink u-bg--secondary"><img src="https://placekitten.com/300/300" width="300" height="300" class="l-block" /></li>
        <li><img src="https://placekitten.com/300/300" width="300" height="300" class="l-block" /></li>
        <li><img src="https://placekitten.com/300/300" width="300" height="300" class="l-block" /></li>
      </ul>
    `}
...
<Canvas>
  <Story name="Flex wrap for buttons">
    {`
      <ul class="l-flex l-flex--wrap o-list-reset">
        <li class="u-margin--right u-margin--bottom"><button type="button">An action</button></li>
        <li class="u-margin--right u-margin--bottom"><button type="button">Another action</button></li>
        <li class="u-margin--right u-margin--bottom"><button type="button">A longer-named action</button></li>
        <li class="u-margin--right u-margin--bottom"><button type="button">Action</button></li>
      </ul>
    `}
  </Story>
</Canvas>
...
Flex defaults to laying out children in horizontal rows. To layout items vertically in columns, use `.l-flex--col`.

<Canvas>
  <Story name="Flex col">
    {`
      <ul class="l-flex l-flex--col o-list-reset">
        <li><img src="https://placekitten.com/300/300" width="300" height="300" class="l-block" /></li>
...
The flex classes can be combined: use `.l-flex--align-center` with `.l-flex--col` to get a centered column.

<Canvas>
  <Story name="Flex col with align center">
    {`
      <ul class="l-flex l-flex--col l-flex--align-center o-list-reset">
        <li><img src="https://placekitten.com/300/300" width="300" height="300" class="l-block" /></li>
        <li>Text content here</li>
        <li><img src="https://placekitten.com/300/300" width="300" height="300" class="l-block" /></li>
        <li><img src="https://placekitten.com/300/300" width="300" height="300" class="l-block" /></li>

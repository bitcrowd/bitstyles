...
These examples show how that base flex layout behaves with different content. The second of each of the example blocks shows the same layout, but with one of the children being given the `l-flex__grow-1` class, and the third shows one given `.l-flex__shrink-0`.

Make one of the children `.l-flex__grow-1` to make it take any available space that’s left over. If there is no space left over, it becomes the same size as its siblings.
...
<Canvas isColumn>
  ...
  <Story name="Flex, with grow-1 child">
    {`
      <ul class="l-flex o-list-reset">
        <li>List item one</li>
        <li class="l-flex__grow-1 u-bg--brand-2">Important content here</li>
        <li>List item three</li>
        <li>List item four</li>
      </ul>
    `}
  ...
  <Story name="Flex with intrinsic-width content, with primary child">
    {`
      <ul class="l-flex o-list-reset">
        ...
        <li class="l-flex__grow-1 u-bg--brand-2">
          <img src="https://placekitten.com/300/300" width="300" height="300" class="u-block" />
        </li>
        <li>
          <img src="https://placekitten.com/300/300" width="300" height="300" class="u-block" />
  ...
  <Story name="Flex with intrinsic-width content, with no-shrink child">
    {`
      <ul class="l-flex o-list-reset">
        ...
        <li class="l-flex__shrink-0 u-bg--brand-2">
          <img src="https://placekitten.com/300/300" width="300" height="300" class="u-block" />
        </li>
        <li>
          <img src="https://placekitten.com/300/300" width="300" height="300" class="u-block" />

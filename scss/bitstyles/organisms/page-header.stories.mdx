      ...
      <article>
        <header class="u-bg--gray-5 u-padding-l--top">
          <div class="o-content">
            ...
            <ul class="u-list-reset u-flex u-overflow--x l-items-end o-button--tab-container u-margin-m--bottom" role="tablist" aria-label="Patient data">
      ...
      <article>
        <header class="u-bg--gray-5 u-padding-l--top">
          <div class="o-content">
            ...
            <ul class="u-list-reset u-flex u-overflow--x u-items-end o-button--tab-container u-margin-m--bottom" role="tablist" aria-label="Patient data">
              <li class="u-margin-s--right">
                <button class="o-button o-button--tab" role="tab" aria-selected="true" aria-controls="tab-panel-1" id="tab-1" tabindex="0">
                  Personal details
                </button>

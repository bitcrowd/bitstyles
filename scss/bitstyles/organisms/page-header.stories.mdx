        ...
        <header class="u-bg--gray-5 u-padding-l--top">
          <div class="a-content">
            <div class="u-padding-xl--bottom">
              <ol class="c-breadcrumbs u-h6 u-list-reset u-flex u-flex--wrap u-items-center">
                <li class="u-margin-xs--right u-flex u-items-center">
                  <a href="/">Main section</a>
                </li>
                <li class="u-margin-xs--right u-flex u-items-center">
                  <svg class="a-icon a-icon--m u-fg--gray-30 u-margin-xs--right" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                ...
                <li class="u-margin-xs--right u-flex u-items-center">
                  <svg class="a-icon a-icon--m u-fg--gray-30 u-margin-xs--right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" aria-hidden="true">
                    <path d="M32.83,97.22a6.07,6.07,0,1,1-8.59-8.58L58.59,54.29a6.07,6.07,0,0,0,0-8.58L24.24,11.36a6.07,6.07,0,1,1,8.59-8.58L75.76,45.71a6.07,6.07,0,0,1,0,8.58Z" fill-rule="evenodd"/>
                  </svg>
                  <a href="/">Sub page</a>
                </li>
              ...
              <div class="u-flex u-justify-between u-flex--wrap u-items-center">
                ...
                <ul class="u-list-reset u-flex u-flex--wrap">
                  <li class="u-margin-s--right u-margin-m--bottom u-relative@m">
                    <button type="button" class="a-button a-button--dropdown" aria-controls="dropdown-1" aria-expanded="false">
            ...
            <ul class="u-list-reset u-flex u-overflow--x l-items-end a-button--tab-container u-margin-m--bottom" role="tablist" aria-label="Patient data">
          ...
          <div class="a-content">
            <div class="u-padding-xl--bottom">
              ...
              <div class="u-flex u-justify-between u-flex--wrap u-items-center">
                ...
                <ul class="u-list-reset u-flex u-flex--wrap">
                  <li class="u-margin-s--right u-margin-m--bottom u-relative@m">
                    <button type="button" class="a-button a-button--dropdown" aria-controls="dropdown-1" aria-expanded="true">
                      <span class="a-button__label">Move</span>
                      <svg class="a-button__icon a-icon a-icon--m" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                        <path d="M2.78,32.83a6.07,6.07,0,0,1,8.58-8.59L45.71,58.59a6.07,6.07,0,0,0,8.58,0L88.64,24.24a6.07,6.07,0,1,1,8.58,8.59L54.29,75.76a6.07,6.07,0,0,1-8.58,0Z" fill-rule="evenodd"/>
                      </svg>
                    </button>
                    <ul class="a-dropdown a-dropdown--reverse u-overflow--y u-list-reset u-margin-s--top" aria-hidden="false" id="dropdown-1">
                      <li>
            ...
            <ul class="u-list-reset u-flex u-overflow--x u-items-end a-button--tab-container u-margin-m--bottom" role="tablist" aria-label="Patient data">
              <li class="u-margin-s--right">
                <button class="a-button a-button--tab" role="tab" aria-selected="true" aria-controls="tab-panel-1" id="tab-1" tabindex="0">
                  Personal details
                </button>
              ...
              <div class="u-flex u-justify-between u-flex--wrap u-items-center">
                ...
                <ul class="u-list-reset u-flex u-flex--wrap">
                  <li class="u-margin-s--right u-margin-m--bottom">
                    <a href="/" class="a-button a-button--dropdown">Move…</a>
                  </li>
                  <li class="u-margin-m--bottom">
                    <a href="/" class="a-button">Edit</a>
                  </li>

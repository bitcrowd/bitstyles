...
A button that when clicked reveals a floating menu of links. This is a combination of an `.a-button--dropdown` as the button that is clicked to show/hide the menu, an `.a-dropdown` menu that’s the container for a series of `.a-button--menu` sub-items.

For the sake of clarity, the examples shown here are all presented with the menus already visible, but when you’re using them in a project the `.a-dropdown` must get the class `.u-hidden`. The component requires JS (not yet provided) to remove/add that class when the user clicks the `.a-button--dropdown`.

<Canvas>
  <Story name="Dropdown menu">
    {`
      <div class="u-relative" style="min-height:15rem;">
        <button type="button" class="a-button a-button--dropdown u-h6" aria-controls="dropdown-1" aria-expanded="true">
        ...
        <ul class="a-dropdown u-overflow--y u-list-reset u-margin-s--top" aria-hidden="false" id="dropdown-1">
          <li>
...
<Canvas>
  <Story name="Dropdown with avatar user-profile link">
    {`
      <div class="u-relative" style="min-height:15rem;">
        <button type="button" class="a-button a-button--dropdown u-h6" aria-controls="dropdown-2" aria-expanded="true">
          <span class="a-button__label">Account</span>
          <svg class="a-button__icon a-icon a-icon--m" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
            <path d="M2.78,32.83a6.07,6.07,0,0,1,8.58-8.59L45.71,58.59a6.07,6.07,0,0,0,8.58,0L88.64,24.24a6.07,6.07,0,1,1,8.58,8.59L54.29,75.76a6.07,6.07,0,0,1-8.58,0Z" fill-rule="evenodd"/>
          </svg>
        </button>
        <ul class="a-dropdown u-overflow--y u-list-reset u-margin-s--top" aria-hidden="false" id="dropdown-2">
          <li>
            <a href="/" class="a-button a-button--menu u-h6">
...
<Canvas>
  <Story name="Dropdown with non-button/link content">
    {`
      <div class="u-relative" style="height: 15rem">
        <button type="button" class="a-button a-button--dropdown u-h6" aria-controls="dropdown-3" aria-expanded="true">
          <span class="a-button__label">Account</span>
          <svg class="a-button__icon a-icon a-icon--m" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
            <path d="M2.78,32.83a6.07,6.07,0,0,1,8.58-8.59L45.71,58.59a6.07,6.07,0,0,0,8.58,0L88.64,24.24a6.07,6.07,0,1,1,8.58,8.59L54.29,75.76a6.07,6.07,0,0,1-8.58,0Z" fill-rule="evenodd"/>
          </svg>
        </button>
        <ul class="a-dropdown u-overflow--y u-list-reset u-margin-s--top" aria-hidden="false" id="dropdown-3">
          <li>
  ...
  <Story name="Dropdown, reverse-aligned">
    ...
    <div class="u-flex u-justify-end">
      <div class="u-relative" style="height: 15rem">
        ...
        <ul class="a-dropdown a-dropdown--reverse u-overflow--y u-list-reset u-margin-s--top" aria-hidden="false" id="dropdown-3">
          <li>
            <div class="u-padding-xs--top u-padding-xs--bottom u-padding-s--left u-padding-s--right u-flex u-items-center u-h6 u-line-height--min">
              <div class="a-avatar a-avatar--l u-flex__shrink-0 u-flex u-items-center u-margin-s--right">
                <img src="https://placekitten.com/100/100" width="46" height="46" alt="Username’s avatar" />

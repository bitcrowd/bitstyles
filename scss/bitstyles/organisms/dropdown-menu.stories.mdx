  ...
  <Story name="Dropdown menu">
    {`
      <div class="u-relative" style="min-height:15rem;">
        ...
        <ul class="o-dropdown u-overflow--y u-list-reset u-margin-s--top" aria-hidden="false" id="dropdown-1">
          <li>
  ...
  <Story name="Dropdown with avatar user-profile link">
    {`
      <div class="u-relative" style="min-height:15rem;">
        ...
        <ul class="o-dropdown u-overflow--y u-list-reset u-margin-s--top" aria-hidden="false" id="dropdown-2">
          <li>
            <a href="/" class="o-button o-button--menu u-h6">
              <div class="o-button__avatar o-avatar o-avatar--l u-flex__shrink-0 u-flex u-items-center">
                <img src="https://placekitten.com/100/100" width="46" height="46" alt="Username’s avatar" />
              </div>
              <div class="o-button__label u-flex u-flex--col u-items-start">
  ...
  <Story name="Dropdown with non-button/link content">
    {`
      <div class="u-relative" style="height: 15rem">
        ...
        <ul class="o-dropdown u-overflow--y u-list-reset u-margin-s--top" aria-hidden="false" id="dropdown-3">
          <li>
            <div class="u-padding-xs--top u-padding-xs--bottom u-padding-s--left u-padding-s--right u-flex u-items-center u-h6 u-line-height--min">
              <div class="o-avatar o-avatar--l u-flex__shrink-0 u-flex u-items-center u-margin-s--right">
                <img src="https://placekitten.com/100/100" width="46" height="46" alt="Username’s avatar" />
              </div>
...
When you know the menu will be at the right edge of the viewport, give your dropdown `.o-dropdown--reverse` to align the menu flush to the right.
  ...
  <Story name="Dropdown, reverse-aligned">
    ...
    <div class="u-flex u-justify-end">
      <div class="u-relative" style="height: 15rem">
        ...
        <ul class="o-dropdown o-dropdown--reverse u-overflow--y u-list-reset u-margin-s--top" aria-hidden="false" id="dropdown-3">
          <li>
            <div class="u-padding-xs--top u-padding-xs--bottom u-padding-s--left u-padding-s--right u-flex u-items-center u-h6 u-line-height--min">
              <div class="o-avatar o-avatar--l u-flex__shrink-0 u-flex u-items-center u-margin-s--right">
                <img src="https://placekitten.com/100/100" width="46" height="46" alt="Username’s avatar" />

  ...
  <Story name="Informational modal" inline={false} height="80vh">
    {`
      ...
      <div class="o-modal" data-a11y-dialog="dialog_1" aria-hidden="true" aria-labelledby="dialog-title">
        ...
        <div class="a-content a-content--s o-modal__content a-card u-padding-l3@m u-padding-l u-flex u-flex-col" role="document">
  ...
  <Story name="Modal dialog" inline={false} height="80vh">
    ...
    <div class="o-modal" data-a11y-dialog="dialog_1" aria-hidden="true" aria-labelledby="dialog-title">
      ...
      <div class="a-content a-content--s o-modal__content a-card u-padding-l3@m u-padding-l u-flex u-flex-col" role="document">
        ...
        <ul class="u-list-none u-grid u-grid-cols-2@m u-gap-l u-items-center u-margin-l2-top">
...
<Canvas>
  <Story name="Modal with long text" inline={false} height="80vh">
    ...
    <div class="o-modal" data-a11y-dialog="dialog_1" aria-hidden="true" aria-labelledby="dialog-title">
      <div class="o-modal__overlay" tabindex="-1" title="Close modal" data-a11y-dialog-hide></div>
      <div class="a-content a-content--m o-modal__content a-card u-padding-l3@m u-padding-l u-flex u-flex-col" role="document">
        <header class="u-flex u-flex-col u-items-center">
          <div class="a-badge a-badge--brand-1 u-padding-m u-margin-s2-bottom">
            <svg width="18" height="18" class="a-icon a-icon--l3" aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
              <use xlink:href="${icons}#icon-mail"></use>

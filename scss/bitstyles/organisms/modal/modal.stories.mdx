...
<Canvas>
  <Story name="Informational modal" inline={false} height="80vh">
    {`
      ...
      <div class="o-modal" id="dialog_1" aria-hidden="false" aria-labelledby="dialog-title">
        <div class="o-modal__overlay" tabindex="-1" data-a11y-dialog-hide title="Close modal"></div>

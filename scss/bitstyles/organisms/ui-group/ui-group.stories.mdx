  ...
  <Story name="UI group - buttons">
    {`
      <ul class="o-ui-group u-flex u-list-none">
        ...
        <li>
          <button type="button" class="a-button a-button--ui o-ui-group__item u-border-radius-0">Middle</button>
        </li>
        <li>
          <button type="button" class="a-button a-button--ui u-border-radius-0-tl u-border-radius-0-bl">Last</button>
        </li>
      </ul>
    `}
  </Story>
  ...
  <Story name="UI group - input & button">
    {`
      <ul class="o-ui-group u-flex u-list-none">
        ...
        <li class="u-flex">
          <button type="button" class="a-button a-button--ui u-border-radius-0-tl u-border-radius-0-bl">Search</button>
        </li>
      </ul>
    `}
  </Story>

    ...
    {`
      <div class="u-relative" style="height: 10rem; width: 30rem">
        <ul class="a-dropdown u-overflow-y-auto a-list-reset">
          <li>
            <a href="/" class="a-button a-button--menu a-button--transparent u-h6">Settings</a>
          </li>
          <li>
            <a href="/" class="a-button a-button--menu a-button--transparent u-h6">Help</a>
          </li>
          <li>
            <a href="/" class="a-button a-button--menu a-button--transparent u-h6">Privacy</a>
          </li>
          <li role="separator"></li>
          <li>
            <a href="/" class="a-button a-button--menu a-button--transparent u-h6">Sign out</a>
          </li>
        </ul>
      </div>
    `}

...
<Canvas>
  <Story name="Badge">
    {`
      <span class="a-badge a-badge--brand-gray u-h6 u-font-medium">Urgent</span>
      <span class="a-badge a-badge--brand-gray u-h6 u-font-medium">In progress</span>
    `}
  </Story>
</Canvas>
    ...
    {`
      <ul class="a-list-reset u-flex">
        <li class="u-margin-s-right">
          <span class="a-badge a-badge--brand-gray u-h6 u-font-medium">gray</span>
        </li>
        <li class="u-margin-s-right">
...
<Canvas>
  <Story name="Badge — with buttons">
    {`
      <ul class="a-list-reset u-flex">
        <li class="u-margin-s-right">
          <span class="a-badge a-badge--brand-gray u-h6 u-font-medium">
            badge 1

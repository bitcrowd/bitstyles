...
<Canvas>
  <Story id="atoms-button--primary"/>
  <Story id="atoms-button--secondary" />
  <Story id="atoms-button--transparent" />
  <Story id="atoms-button--outline" />
  <Story id="atoms-button--tab" />
</Canvas>
...
<Canvas>
  <Story id="atoms-button--danger-primary"/>
  <Story id="atoms-button--danger-secondary"/>
  <Story id="atoms-button--danger-transparent"/>
  <Story id="atoms-button--danger-outline"/>
</Canvas>

...
The color palette is available as CSS custom properties. In the default configuration, they are namespaced with `bs`, see [setup](/story/design-tokens-setup--page) and [`Design Tokens/Overview`](/docs/design-tokens--overview):

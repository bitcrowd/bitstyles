...
Available aspect ratios can be customized by overriding the Sass map `$values`, for each providing the name for the class as the key, and a sass map containing `width` and `height`:

...
Apply a CSS box-shadow to the element. By default this is selected from the standard set of shadows, but you can specify any shadow (see the “Customization” section below).

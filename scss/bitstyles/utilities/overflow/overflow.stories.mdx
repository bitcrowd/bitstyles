  ...
  <Story name="u-overflow-x-auto">
    {`
      <div class="u-overflow-x-auto u-bg-brand-2" style="width: 10rem">
        u-overflow-x-auto Jelly&nbsp;cake&nbsp;marshmallow.&nbsp;Pie&nbsp;cotton&nbsp;candy&nbsp;chupa&nbsp;chups&nbsp;marzipan&nbsp;liquorice&nbsp;cheesecake&nbsp;wafer. <a href="https://duckduckgo.com">DDG</a>
      </div>
    `}
  </Story>
</Canvas>
...
Available overflow values can be customized by overriding the `$values` Sass list. Provide the name for the class and the property as the key, and a Sass map of classname/property value pairs.

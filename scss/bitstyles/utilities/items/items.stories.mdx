...
Customize the available align-items values by overriding the `$values` Sass map. Provide the name to be used for the class as the key, and the value for the `align-items` property:

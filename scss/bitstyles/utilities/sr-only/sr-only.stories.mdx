...
The class can be made available at various breakpoints by overriding the `$breakpoints` Sass list, and including the names of breakpoints from the global breakpoints list:

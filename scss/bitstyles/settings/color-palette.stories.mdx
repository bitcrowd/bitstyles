...
```css
--bs-color-brand-1-light-3: #f4f2ff;
--bs-color-brand-1-light-3-rgb: 244, 242, 255;
--bs-color-brand-1-light: #c8bfff;
--bs-color-brand-1-light-1-rgb: 200, 191, 255;
--bs-color-brand-1-base: #644dff;
--bs-color-brand-1-base-rgb: 100, 77, 255;
// …
```

Note that each color is also output as rgb tuples, to make using them in CSS color functions a little easier e.g. `rgba(var(--bs-color-brand-1-light-3), 0.5)`
...
console.log(colorPalette['brand-1.light-3']); // '#f4f2ff'

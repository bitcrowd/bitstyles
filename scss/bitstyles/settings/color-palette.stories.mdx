...
```css
--bs-color-brand-1-lighter: #f4f2ff;
--bs-color-brand-1-lighter-rgb: 244, 242, 255;
...
- The `accent-gray` colors are a grayscale accented with a color (your brand-1 color by default).

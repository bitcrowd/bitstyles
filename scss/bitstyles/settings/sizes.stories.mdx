...
Using a central scale of sizes maintains consistency in spacing (most often padding and margins) throughout your project. The default sizes are based on font-size to keep the spacing tied to the typography. For users who view your content at a different font-size, the spacing will remain proprtional and usable.
...
@use '~bitstyles/scss/bitstyles/settings/layout' with (
  $sizes: (
    "0": 0,
    "1": 1px, // add some pixel-based sizes for small adjustments
    "xxxs": 0.125rem,
    "xxs": 0.25rem,
    "xs": 0.5rem,
    "s": 0.75rem,

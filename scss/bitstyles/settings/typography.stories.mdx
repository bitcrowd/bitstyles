...
- [responsive typography](/docs/base/typography) — font-sizes specified for HTML elememnts (e.g. `h1` – `h6`) that adjust to the size of the viewport using a mobile-first approach
- [utility classes](/docs/utilities/typography) that apply the same responsive typography as the base elements, for when you need arbritrary elements to consistently match your heading elements
- [utility classes](/docs/utilities/typography) that apply specific font-sizes at specified breakpoints

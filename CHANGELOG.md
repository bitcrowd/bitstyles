...
- Default visual design for buttons has been updated — colors have been refreshed utilizing the new palette, and we’ve added a new `outline` button that has a border. If you were overriding the default configuration for buttons, you may see no change.
